...
module nios_system_mm_interconnect_0 (
	...
	wire  [17:0] switch_s1_agent_m0_address;                                                         // switch_s1_agent:m0_address -> switch_s1_translator:uav_address
	...
	wire  [94:0] switch_s1_agent_rf_source_data;                                                     // switch_s1_agent:rf_source_data -> switch_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] switch_s1_agent_rsp_fifo_out_data;                                                  // switch_s1_agent_rsp_fifo:out_data -> switch_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> switch_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // switch_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> switch_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> switch_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> switch_s1_agent:cp_endofpacket
	...
	wire  [94:0] led_s1_agent_rf_source_data;                                                        // LED_s1_agent:rf_source_data -> LED_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] led_s1_agent_rsp_fifo_out_data;                                                     // LED_s1_agent_rsp_fifo:out_data -> LED_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> LED_s1_agent:cp_data
	...
	wire         switch_s1_agent_rp_valid;                                                           // switch_s1_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_005:sink_data
	wire         switch_s1_agent_rp_ready;                                                           // router_005:sink_ready -> switch_s1_agent:rp_ready
	wire         switch_s1_agent_rp_startofpacket;                                                   // switch_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         switch_s1_agent_rp_endofpacket;                                                     // switch_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [93:0] led_s1_agent_rp_data;                                                               // LED_s1_agent:rp_data -> router_006:sink_data
	...
	wire         switch_s1_agent_rdata_fifo_src_valid;                                               // switch_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] switch_s1_agent_rdata_fifo_src_data;                                                // switch_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         switch_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_003:in_0_ready -> switch_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> switch_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> switch_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // switch_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> switch_s1_agent:rdata_fifo_sink_error
